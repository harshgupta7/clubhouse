; things to customize
(= this-site*    "clubhouse"
   site-url*     "http://clubhouse.tech/"
   parent-url*   "http://www.clubhouse.tech"
   favicon-url*  ""
   site-desc*    "What this site is about."               ; for rss feed
   site-color*   (color 100 149 237)
   border-color* (color 100 20 1)
   prefer-url*   t)
...
(= toplabels* '(nil "welcome1" "new" "threads" "comments" "leaders" "*"))
...
(= title-limit* 80
   retry*       "Please try again. URL requires http(s)://"
